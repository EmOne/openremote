...
export class AssetModelUtil {
    ...
    public static getValueDescriptor(name?: string): ValueDescriptor | undefined {
        ...
        if (valueDescriptor && isArray) {
            valueDescriptor = {...valueDescriptor, isArray: true};
        }
        return valueDescriptor;
    }

    public static getAttributeAndValueDescriptors(assetType: string | undefined, attributeOrNameOrDescriptor: Attribute<any> | string | AttributeDescriptor | undefined): [AttributeDescriptor | undefined, ValueDescriptor | undefined] {
        let attributeDescriptor: AttributeDescriptor | undefined;
        let valueDescriptor: ValueDescriptor | undefined;
        let attributeTypeOrDescriptor: string | ValueDescriptor | undefined;
        ...
        if (typeof(attributeOrNameOrDescriptor) === "string") {
            attributeDescriptor = this.getAttributeDescriptor(attributeOrNameOrDescriptor as string, assetTypeInfo);
        } else {
